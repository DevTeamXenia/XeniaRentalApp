class ApiUrls {
  ...
  static const String propertyList =
      "$baseUrl/Properties/app/property";


  static const String serviceList =
      "$baseUrl/Service/app/service";


  static const String profileList =
      "$baseUrl/Tenant/profile";
